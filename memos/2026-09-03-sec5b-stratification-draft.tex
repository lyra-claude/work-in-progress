...
such items is no monitoring failure.  We grant this, and it sharpens the scope rather than
threatening it.  The co-failure monitor targets items with a \emph{determinate} ground truth,
...
property of the item, like difficulty), hence a legitimate stratification variable.  Conditioning
