...
\newcommand{\commithash}{COMMIT-HASH-PLACEHOLDER}
...
$H^1 \ge 1$ obstructs error-independence; $H^1 = 0$ is \emph{ambiguous} (cannot distinguish genuine independence from monoculture-by-degeneracy). Keep as the structural/descriptive leg. The $\theta_{123}$ three-body coupling (``Co-failure M\"{o}bius Conjecture'') is named here and deferred to future work --- \textbf{[open]}, do not build the spine on it.
